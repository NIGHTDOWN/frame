<?php /* "tpl/admin/frame_index.html" //NG框架模板引擎;仅适用本系统框架; 2018-07-23 19:42:39 �й���׼ʱ�� */ ?>
        ...
        <div class="fram_top">
            <div class="oe_fntop">
                <div class="oe_adminlogo" >
                    <a href="<?php echo url(array('mod' => " frame",'group' => "admin",'action' => "run"), $this);?>"></a>
                </div>
            ...
            <ul>
                ...
                <li class="oe_top_con2 oe_tout" onmouseover="this.className='oe_top_con2 oe_thover'" onmouseout="this.className='oe_top_con2 oe_tout'">
                    ...
                    <div class="oe_la_menu">
                        <a class="oe_la_ico1" href='<?php echo url(array('action' => "cgpwd",'args' => "adminid:" . $this->_vars['admin']['adminid'] . "",'mod' => "admins",'group' => "admin"), $this);?>' target="main">修改密码</a>
                        <a class="oe_la_ico2" href="<?php echo url(array('action' => "logout",'mod' => "login",'group' => "admin"), $this);?>">退出</a>
                    </div>
                </li>
                <li class="oe_top_con3 oe_tout" onmouseover="this.className='oe_top_con3 oe_thover'" onmouseout="this.className='oe_top_con3 oe_tout'">
                    <a href="">更新数据</a>
                    <div class="oe_la_menu">
                        <a class="oe_la_ico3" href="<?php echo url(array('action' => " clearcache",'mod' => "siteset",'group' => "admin"), $this);?>">清除页面缓存</a>
                        <a class="oe_la_ico3" href="<?php echo url(array('action' => " updatecache",'mod' => "siteset",'group' => "admin"), $this);?>">更新数据缓存</a>
                    </div>
                </li>
...
" id="left" style="overflow-y:auto; overflow-x:hidden;<?php if ($this->_vars['sy'] != 0): ?>display:none<?php endif; ?>">
        ...
        <?php $this->assign('tpldata', vo_list("mod=@!backstage_menu!@ fun=@!get_all!@ orderby=@!s:up,f:orders!@ array=@!'depth:2,flag:0,parentid:'{$this->_vars['volist']['catid']}!@")); ?>
        ...
        <ul class="oe_leftmenu" style="margin-top:15px;">
            <?php if (count((array)$this->_vars['tpldata'])): foreach ((array)$this->_vars['tpldata'] as $this->_vars['yy'] => $this->_vars['volist2']): ?>
             ...
             <?php if (vo_list ( "mod={power} type={am} fun={checkuser} param1={" . $this->_vars['volist2']['mod'] . "+" . $this->_vars['volist2']['action'] . "}" )): ?>
                <li class="oe_submenu">
                <ul>
...
"></i><a target="main" href="javascript:;"><?php echo $this->_vars['volist2']['catname']; ?>
                    ...
                    <?php $this->assign('tpldata2', vo_list("mod=@!backstage_menu!@ fun=@!get_all!@ orderby=@!s:up,f:orders!@ array=@!'depth:3,flag:0,parentid:'{$this->_vars['volist2']['catid']}!@}")); ?>
                    <?php if (count((array)$this->_vars['tpldata2'])): foreach ((array)$this->_vars['tpldata2'] as $this->_vars['i'] => $this->_vars['volist3']): ?>
                  <?php if (vo_list ( "mod={power} type={am} fun={checkuser} param1={{" . $this->_vars['volist3']['mod'] . "}+{" . $this->_vars['volist3']['action'] . "}}" )): ?>
                    <li onclick="acls('oe_mon',$(this));" class="oe_nextli <?php if ($this->_vars['i'] == 0): ?>oe_mon<?php endif; ?>   "><label></label><a target="main" href='<?php echo url(array('group' => admin,'mod' => $this->_vars['volist3']['mod'],'action' => $this->_vars['volist3']['action']), $this);?>'>        <?php echo $this->_vars['volist3']['catname']; ?>
</a></li>
               <?php endif; ?>
                    <?php endforeach; endif; ?>
    ...
    <div class="oe_fright">
        <iframe name="main" id="main" frameborder="no" src="<?php echo url(array('mod' => "frame",'action' => "main",'group' => "admin"), $this);?>"></iframe>
    </div>
    <div class="oe_bottom">
