<?php require_once('E:\www\ng169\source\core\template\src\plugins\modifier.date_format.php'); $this->register_modifier("date_format", "tpl_modifier_date_format");  /* "tpl/templets/default/kb.html" //NG框架模板引擎;仅适用本系统框架; 2018-10-11 22:04:50 �й���׼ʱ�� */ ?>

<?php $this->assign('kb', vo_list("fun=@!getcomment!@ mod=@!index!@ type=@!im!@"));  if (count((array)$this->_vars['kb'])): foreach ((array)$this->_vars['kb'] as $this->_vars['volist']): ?>
					<li class="fn-clear">
						...
						<div class="fore2 fn-clear">
							<div class="txt"><a target="_blank" href="<?php echo url(array('mod' => 'product','action' => 'detail','args' => "productid:" . $this->_vars['volist']['productid'] . ""), $this);?>">【<?php echo $this->_run_modifier($this->_vars['volist']['productname'], 'tostr', 'PHP', 1); ?>
