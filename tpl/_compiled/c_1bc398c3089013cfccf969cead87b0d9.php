<?php require_once('F:\www\ds\source\core\template\src\plugins\modifier.date_format.php'); $this->register_modifier("date_format", "tpl_modifier_date_format");  /* "tpl/admin/user_index.html" //NG框架模板引擎;仅适用本系统框架; 2018-07-14 23:50:50 �й���׼ʱ�� */ ?>
      ...
      <div class="oe_tools_bar clearfix">
        ...
        <script>
        	function dcexcel($html){
        		$url='<?php echo url(array('action' => 'excel'), $this);?>';
           ...
           <a href="<?php echo url(array('group' => 'admin','action' => 'add_view'), $this);?>" class="icon-plus"> 添加</a>
               ...
               <td  ><?php echo $this->_vars['volist']['mobile']; ?>
                ...
                <td ><?php echo $this->_run_modifier($this->_vars['volist']['logtime'], 'date_format', 'plugin', 1, "%Y-%m-%d "); ?>
                 ...
                 <td ><?php echo $this->_vars['volist']['cash']; ?>
                  ...
                  <td >
                  <img src="
                  	<?php  echo vo_list("fun=@!getlevelimg2!@ type=@!am!@ mod=@!userlevel!@  param1=@!{$this->_vars['volist']['ugood']}'-'{$this->_vars['volist']['ubad']}!@"); ?>">
                  </td>
...
" name="flag" tag="ajaxchoose" style="cursor:pointer"><?php if ($this->_vars['volist']['flag'] == 0): ?>
            ...
            <td style="text-align:center;" class="a_edit_del">
               <a class="oe_ico_green" target="_blank" href="<?php echo url(array('mod' => "login_user",'group' => "admin",'action' => "login",'args' => "uid:" . $this->_vars['volist']['uid'] . ""), $this);?>">快速登入</a>
              
               <a class="oe_ico_blue" href="<?php echo url(array('action' => "",'mod' => "order",'args' => "uid:" . $this->_vars['volist']['uid'] . ""), $this);?>">查看交易记录</a> 
               <a class="oe_ico_orange" href="<?php echo url(array('action' => "cgpwd",'args' => "uid:" . $this->_vars['volist']['uid'] . ""), $this);?>">修改密码</a> 
                <a class="oe_ico_blue" href="<?php echo url(array('action' => "show",'args' => "uid:" . $this->_vars['volist']['uid'] . ""), $this);?>">查看</a>  
              <a class="oe_ico_green" href="<?php echo url(array('action' => "edit",'args' => "uid:" . $this->_vars['volist']['uid'] . ""), $this);?>">充值</a> 
              <a class="oe_ico_green" href="<?php echo url(array('action' => "edit",'args' => "uid:" . $this->_vars['volist']['uid'] . ""), $this);?>">发信</a> 
                <a class="oe_ico_red" a="<?php echo url(array('action' => "del",'args' => "uid:" . $this->_vars['volist']['uid'] . ""), $this);?>" onClick="boxyn($(this))">删除</a>
            </td>
          </tr>
...
<form method="post" action="<?php echo url(array('mod' => "",'action' => "addmp",'args' => "",'group' => ""), $this);?>" >
...
<form method="post" action="<?php echo url(array('mod' => "",'action' => "addpdb",'args' => "",'group' => ""), $this);?>" >
    <input name="uid" type="hidden" value="<?php echo $this->_vars['select']['uid']; ?>
">
...
<form method="post" action="<?php echo url(array('mod' => "",'action' => "hcash",'args' => "",'group' => ""), $this);?>" >
    <input name="uid" type="hidden" value="<?php echo $this->_vars['select']['uid']; ?>
">
     <table class="oe_table_warp">
         <tr>
