<?php /* "ngtpl[start]:tpl/mtpl/category_index.html:[end]" 

	//NG框架模板引擎;仅适用本系统框架; 2018-11-22 10:45:48 */ ?>
					...
					<div id="bodyCont" class="fullscreen index">
						...
						<header class="jd-header header-section-search header-banner">
							<div class="jd-header-new-bar">
								<div onclick="_go_url('<?php echo \ng169\hook\url(array('mod' => 'index'), $this);?>')" class="jd-header-icon-back ">
									<span></span>
								</div>
								<form action="<?php echo \ng169\hook\url(array('mod' => 'search'), $this);?>" method="POST" id='ff'>
						...
						<div class="category-viewport">
								...
								<div >
									<ul >
										...
										<li <?php if ($this->_vars['i'] == 0): ?>class="on"<?php endif; ?> >
											<a  href="<?php echo \ng169\hook\url(array('mod' => 'category','action' => 'level2','args' => "id:" . $this->_vars['volist']['catid'] . ""), $this);?>" target="right_category"><?php echo $this->_vars['volist']['catname']; ?>
</a>
										</li>
							...
							<div class="category-content">
								<iframe src='<?php echo \ng169\hook\url(array('mod' => 'category','action' => 'level2','args' => "id:" . $this->_vars['data']['0']['catid'] . ""), $this);?>' name='right_category'></iframe>
							</div>
						</div>
