<?php require_once('D:\work2\source\core\template\src\plugins\modifier.date_format.php'); $this->register_modifier("date_format", "tpl_modifier_date_format");  /* "ngtpl[start]:tpl/mtpl/comment_list.html:[end]" 

	//NG框架模板引擎;仅适用本系统框架; 2018-11-22 11:50:22 */ ?>
		...
		<div class="lib-rates">
			<div class="lib-rates-tags">
				<ul>
					...
					<li class="rates_tag_feedAllCount <?php if ($this->_vars['im'] == 0 && $this->_vars['cm'] == -1): ?>cur<?php endif; ?>"  onclick="_go_url('<?php echo \ng169\hook\url(array('action' => 'list','mod' => 'comment','args' => "productid:" . $this->_vars['get']['productid'] . ""), $this);?>')">全部</li>
					<li class="rates_tag_feedGoodCount <?php if (( $this->_vars['get']['cmlevel'] ) == 1): ?>cur<?php endif; ?>"  onclick="_go_url('<?php echo \ng169\hook\url(array('action' => 'list','mod' => 'comment','args' => "cmlevel:1,productid:" . $this->_vars['get']['productid'] . ""), $this);?>')">好评</li>
					<li class="rates_tag_feedNormalCount <?php if ($this->_vars['im'] == 0 && $this->_vars['cm'] == 0): ?>cur<?php endif; ?>"  onclick="_go_url('<?php echo \ng169\hook\url(array('action' => 'list','mod' => 'comment','args' => "cmlevel:0,productid:" . $this->_vars['get']['productid'] . ""), $this);?>')">中评</li>
					<li class="rates_tag_feedBadCount <?php if (( $this->_vars['get']['cmlevel'] ) == 2): ?>cur<?php endif; ?>"  onclick="_go_url('<?php echo \ng169\hook\url(array('action' => 'list','mod' => 'comment','args' => "cmlevel:2,productid:" . $this->_vars['get']['productid'] . ""), $this);?>')">差评</li>
					<li class="rates_tag_feedBadCount <?php if (( $this->_vars['get']['img'] ) == 1): ?>cur<?php endif; ?>"  onclick="_go_url('<?php echo \ng169\hook\url(array('action' => 'list','mod' => 'comment','args' => "img:1,productid:" . $this->_vars['get']['productid'] . ""), $this);?>')">有图</li>
...
" style='    width: 100%;'>
									...
									<div class="rates_header_star">
										<img src="<?php  echo ng169\hook\vo_list("fun=@!getlevelimg1!@ type=@!am!@ mod=@!userlevel!@  param1=@!{$this->_vars['volist']['uid']}!@"); ?>">
									</div>
								</div>
