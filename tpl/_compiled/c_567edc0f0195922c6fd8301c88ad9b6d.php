<?php require_once('D:\work2\source\core\template\src\plugins\modifier.date_format.php'); $this->register_modifier("date_format", "tpl_modifier_date_format");  /* "ngtpl[start]:tpl/admin/template_index.html:[end]" 

	//NG框架模板引擎;仅适用本系统框架; 2018-11-22 18:06:11 */ ?>
...
<div class="oe_tools_bar clearfix">
    <a class="icon-checkbox-checked icon-checkbox-unchecked" href="javascript:;" onClick="tools_select('tmpid[]',this)" title="全选" data="true"> 全选 </a>
    <a class="icon-remove-2 none" href="javascript:;" do="tools_submit({action:'<?php echo \ng169\hook\url(array('action' => "del"), $this);?>',id:'tmpid'})" title="删除" onclick="boxyn($(this))"> 删除</a>
    <a href="<?php echo \ng169\hook\url(array('action' => "add_view"), $this);?>" class="icon-plus" style="display:none">添加</a>
...
<table class="oe_table_list table_cs"  id="paixun">
    ...
    <tbody>
    <?php if (count((array)$this->_vars['template'])): foreach ((array)$this->_vars['template'] as $this->_vars['volist']): ?>
    <tr>
      <td  style="text-align:center;"><input type="checkbox" value="<?php echo $this->_vars['volist']['tmpid']; ?>
" name="tmpid[]"></input></td>
      <td tag="ajaxtext" key="<?php echo $this->_vars['volist']['tmpid']; ?>
" who="<?php echo $this->_vars['c']; ?>
" name="title"> <?php echo $this->_vars['volist']['title']; ?>

      </td>
         <td style="text-align:center;"><?php echo $this->_vars['volist']['idenfity']; ?>
</td>
...
" key="<?php echo $this->_vars['volist']['tmpid']; ?>
...
" name="flag" tag="ajaxchoose" style="cursor:pointer;text-align:center;" >
        ...
        <td  style="text-align:center;" class="a_edit_del">  
              &nbsp;<a class="oe_ico_blue" href="<?php echo \ng169\hook\url(array('action' => "show",'args' => "tmpid:" . $this->_vars['volist']['tmpid'] . ""), $this);?>">编辑</a>
        </td>
      </tr>
...
<div style="display:none;" id="searchbox">
  <form method="post" style="width:400px;" action="">
     ...
     <table  align="center" width="473" class="oe_table_warp">
      <tr>
        <td height="40"  style="text-align:right;">  标识：</td>
        <td>
        <input name="idenfity" class="input-b" type="text" value="<?php echo $this->_vars['where']['idenfity']; ?>
" />
