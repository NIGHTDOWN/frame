<?php /* "tpl/mtpl/product_category.html" //NG框架模板引擎;仅适用本系统框架; 2018-07-14 00:40:59 �й���׼ʱ�� */ ?>
						...
						<section class="J_lazyShopListOrder list_m_mdv">
							<div class="J_orderWrapper">
								<section id="J_order" class="list_m_mdv order">
									...
									<div class="o_item <?php if ($this->_vars['orderby']['f'] == 'collects'): ?>o_cur <?php echo $this->_vars['orderby']['s'];  endif; ?>" onclick="_go_url('<?php if ($this->_vars['orderby']['f'] == 'collects'):  echo url(array('mod' => 'search','args' => "id:" . $this->_vars['where']['id'] . ",word:" . $this->_vars['where']['word'] . ",price1:" . $this->_vars['where']['price1'] . ",price2:" . $this->_vars['where']['price2'] . "," . $this->_vars['by'] . ":collects"), $this); else:  echo url(array('mod' => 'search','args' => "id:" . $this->_vars['where']['id'] . ",word:" . $this->_vars['where']['word'] . ",price1:" . $this->_vars['where']['price1'] . ",price2:" . $this->_vars['where']['price2'] . ",up:collects"), $this); endif; ?>')">推荐
										<div class="price-icon-wrapper  ">
											
										</div></div>

								<div class="o_item  <?php if ($this->_vars['orderby']['f'] == 'sells'): ?>o_cur <?php echo $this->_vars['orderby']['s'];  endif; ?>" onclick="_go_url('<?php if ($this->_vars['orderby']['f'] == 'sells'):  echo url(array('mod' => 'search','args' => "id:" . $this->_vars['where']['id'] . ",word:" . $this->_vars['where']['word'] . ",price1:" . $this->_vars['where']['price1'] . ",price2:" . $this->_vars['where']['price2'] . "," . $this->_vars['by'] . ":sells"), $this); else:  echo url(array('mod' => 'search','args' => "id:" . $this->_vars['where']['id'] . ",word:" . $this->_vars['where']['word'] . ",price1:" . $this->_vars['where']['price1'] . ",price2:" . $this->_vars['where']['price2'] . ",up:sells"), $this); endif; ?>')">销量
									<div class="price-icon-wrapper  ">
								...
								<div class="o_item  <?php if ($this->_vars['orderby']['f'] == 'addtime'): ?>o_cur <?php echo $this->_vars['orderby']['s'];  endif; ?>" onclick="_go_url('<?php if ($this->_vars['orderby']['f'] == 'addtime'):  echo url(array('mod' => 'search','args' => "id:" . $this->_vars['where']['id'] . ",word:" . $this->_vars['where']['word'] . ",price1:" . $this->_vars['where']['price1'] . ",price2:" . $this->_vars['where']['price2'] . "," . $this->_vars['by'] . ":addtime"), $this); else:  echo url(array('mod' => 'search','args' => "id:" . $this->_vars['where']['id'] . ",word:" . $this->_vars['where']['word'] . ",price1:" . $this->_vars['where']['price1'] . ",price2:" . $this->_vars['where']['price2'] . ",up:addtime"), $this); endif; ?>')">上新
								...
								<div class="o_item <?php if ($this->_vars['orderby']['f'] == 'price'): ?>o_cur <?php echo $this->_vars['orderby']['s'];  endif; ?>" onclick="_go_url('<?php if ($this->_vars['orderby']['f'] == 'price'):  echo url(array('mod' => 'search','args' => "id:" . $this->_vars['where']['id'] . ",word:" . $this->_vars['where']['word'] . ",price1:" . $this->_vars['where']['price1'] . ",price2:" . $this->_vars['where']['price2'] . "," . $this->_vars['by'] . ":price"), $this); else:  echo url(array('mod' => 'search','args' => "id:" . $this->_vars['where']['id'] . ",word:" . $this->_vars['where']['word'] . ",price1:" . $this->_vars['where']['price1'] . ",price2:" . $this->_vars['where']['price2'] . ",up:price"), $this); endif; ?>')">
									价格
									<div class="price-icon-wrapper  ">
