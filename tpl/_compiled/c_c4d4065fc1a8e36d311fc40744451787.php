<?php require_once('D:\work2\source\core\template\src\plugins\modifier.date_format.php'); $this->register_modifier("date_format", "tpl_modifier_date_format");  /* "ngtpl[start]:tpl/templets/default/purchase_detail.html:[end]" 
	...
	//NG框架模板引擎;仅适用本系统框架; 2018-11-22 11:51:19 */ ?>
...
',
												url:'<?php echo \ng169\hook\url(array('mod' => $this->_vars['c'],'action' => $this->_vars['a'],'args' => "productid:" . $this->_vars['data']['productid'] . ""), $this);?>',
...
'
									...
									<img src="<?php echo \ng169\hook\url(array('action' => 'qr','args' => "productid:" . $this->_vars['data']['productid'] . ""), $this);?>"></div>
...
<div class="cartinfo">
	...
	<div class="cart-text">
        ...
        <a title="去购物车结算" class="cart-checkout" href="<?php echo \ng169\hook\url(array('group' => 'user','mod' => 'cart'), $this);?>">去购物车结算</a>
        <a class="close-page" onclick="$('#cart_show').fadeOut(500);return false;" href="#">再逛逛</a>
					...
					<div class="sidebar clearfix">
						<div class="shop-info">
						<?php $this->assign('levelimg1', \ng169\hook\vo_list("fun=@!getlevelimg1!@ type=@!am!@ mod=@!shoplevel!@  param1=@!''{$this->_vars['data']['muid']}!@}")); ?>
						<?php $this->assign('levelimg', \ng169\hook\vo_list("fun=@!getlevelimg!@ type=@!am!@ mod=@!shoplevel!@  param1=@!''{$this->_vars['data']['muid']}!@}")); ?>
...
元保证金"><?php echo $this->_vars['data']['bzjcash']; ?>
 元</span>
								...
								<div class="shop-info-fd clearfix">
									<a target="_blank" href="<?php echo \ng169\hook\url(array('mod' => 'shop','action' => 'show','args' => "id:" . $this->_vars['data']['muid'] . ""), $this);?>">进入店铺</a>
			...
			<div class="tabbar-wrap clearfix">
				<div class="shop-search">
					<div class="search-panel">
						<form action="<?php echo \ng169\hook\url(array('mod' => 'shop','action' => 'search','args' => "muid:" . $this->_vars['data']['muid'] . ""), $this);?>" method="post">
...
：<?php echo $this->_vars['volist']['avalue']; ?>
					...
					<div class="reviews-hd-fore1 clearfix">
								...
								<div class="links"><a target="_blank" href="<?php echo \ng169\hook\url(array('mod' => 'shop','action' => 'comment','args' => "id:" . $this->_vars['data']['muid'] . ""), $this);?>"><i></i>店铺评价</a></div>
							</div>
						<iframe style="border:none;width:100%;height:100%;min-height: 1000px;" src="<?php echo \ng169\hook\url(array('mod' => 'comment','action' => 'list','args' => "productid:" . $this->_vars['data']['productid'] . ""), $this);?>"></iframe>
					</div>
...
<em><?php  echo $this->_vars['data']['price']/100; ?></em><span>拍下价格的不同可能会由促销和打折引起的，详情可以咨询卖家。</span></td>
					...
					<iframe style="border:none;width:100%;height:100%;min-height: 1000px;" src="<?php echo \ng169\hook\url(array('mod' => 'order','action' => 'list','args' => "productid:" . $this->_vars['data']['productid'] . ""), $this);?>"></iframe>
					</div>
