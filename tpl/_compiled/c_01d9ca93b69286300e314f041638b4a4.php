<?php /* "ngtpl[start]:tpl/mtpl/login_index.html:[end]" 

	//NG框架模板引擎;仅适用本系统框架; 2018-11-22 10:45:58 */ ?>
...
css3/style_1.css" type="text/css">
	...
	<body>
		<div class="loginContainer">
			<div class="loginBox">
				<div class="sLogo">
					<a href="<?php echo \ng169\hook\url(array('action' => 'run','mod' => 'index'), $this);?>">
...
<li>
												...
												<input class=" w50" name="yzm" value="" type="text" placeholder="验证码" >
												  <img src="<?php echo \ng169\hook\url(array('args' => "",'action' => 'verify','mod' => 'login','group' => 'index'), $this);?>" class="w50" style="float:right" onclick="this.src=this.src" />
												
						</li>
						<li>
							<label>
									<a href="<?php echo \ng169\hook\url(array('action' => '','mod' => 'reg'), $this);?>" class="forget" style="display:none">免费注册</a>
							</label>
							<a href="<?php echo \ng169\hook\url(array('action' => 'forget','mod' => 'login'), $this);?>" class="forget">忘记密码</a>
						</li>

						<li class="firtLi">
							<input id="login_btn" class="subBtn" type="submit" value="登 录">
							<a href="<?php echo \ng169\hook\url(array('action' => '','mod' => 'reg'), $this);?>" class="subBtn">免费注册</a>
						</li>
