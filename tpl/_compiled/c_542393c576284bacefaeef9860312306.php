<?php /* "ngtpl[start]:tpl/mtpl/purchase_detail.html:[end]" 

	//NG框架模板引擎;仅适用本系统框架; 2018-11-22 12:02:34 */ ?>
			...
			<div id="goods">
				<section class="goods" id="goods">
					<ul class="goods-list clear" id="goods_block">
						...
						<li>
							<a href="<?php echo \ng169\hook\url(array('args' => " productid:" . $this->_vars['volist']['productid'] . "",'action' => 'detail','mod' => 'product'), $this);?>" target="_blank">
								<div class="goods-pic">
...
<?php elseif ($this->_vars['vkf']['type'] == 3): ?>
				...
				<li onclick="_go_url('<?php echo \ng169\hook\url(array('mod' => 'msg','action' => 'cheat','group' => 'user','args' => "user:" . $this->_vars['vkf']['num'] . ""), $this);?>')">
					<i class='ygt'></i>
					<div class="kfr">
						<span>称呼：
							<?php echo $this->_vars['vkf']['name']; ?>
			...
			<div class="bottom_bar">
				...
				<div class="bottom_bar_icon">
					<div class="shop" data-spm="shop" onclick="_go_url('<?php echo \ng169\hook\url(array('mod' => 'shop','action' => 'show','agrs' => " id:" . $this->_vars['data']['muid'] . ""), $this);?>')">
						<p class="icon"></p>
						<p class="text">店铺</p>
					</div>
				</div>
