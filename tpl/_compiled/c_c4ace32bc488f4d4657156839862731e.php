<?php /* "ngtpl[start]:tpl/admin/siteset_index.html:[end]" 

	//NG框架模板引擎;仅适用本系统框架; 2018-11-21 13:43:40 */ ?>
...
' type="button" id="oe_img_button">上传图片</button>宽高尺寸为<?php if ($this->_vars['volist']['optionname'] == 'logo'):  echo $this->_vars['config']['logo_img_size'];  elseif ($this->_vars['volist']['optionname'] == 'weixin'):  echo $this->_vars['config']['default_img_size'];  else:  endif; ?>
            <span class="oe_img">  
