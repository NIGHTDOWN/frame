<?php /* "tpl/templets/default/product_category.html" //NG框架模板引擎;仅适用本系统框架; 2018-10-11 22:05:10 �й���׼ʱ�� */ ?>
...
res/pcss.css" rel="stylesheet" type="text/css">
	<div class="w">
    	     ...
    	     <?php if ($this->_vars['pcat']): ?>   
                ...
                <strong>
                <a href="<?php echo url(array('mod' => $this->_vars['c'],'action' => $this->_vars['a'],'args' => "catid:" . $this->_vars['volist']['catid'] . ""), $this);?>"><?php echo $this->_vars['volist']['catname']; ?>
</a>
                </strong>
                <?php else: ?>
                 <span>
                ...
                <strong><a href="<?php echo url(array('mod' => 'index'), $this);?>">首页</a></strong><span>
         &gt; <a href="<?php echo url(array('mod' => $this->_vars['c'],'action' => $this->_vars['a']), $this);?>">全部商品</a>
	 ...
	 <?php if ($this->_vars['cnum'] || $this->_vars['anum']): ?>
        ...
        <?php if ($this->_vars['cnum']): ?>
            ...
            <?php if (count((array)$this->_vars['ccat'])): foreach ((array)$this->_vars['ccat'] as $this->_vars['volist']): ?>
                                                <div>
                <a href="<?php echo url(array('mod' => $this->_vars['c'],'action' => $this->_vars['a'],'args' => "word:" . $this->_vars['where']['word'] . ",catid:" . $this->_vars['volist']['catid'] . ""), $this);?>"><?php echo $this->_vars['volist']['catname']; ?>
</a>
                </div>
<?php endforeach; endif; ?>
...
：</dt>
            ...
            <?php  $this->_vars['key']='att'.$this->_vars['volist']['weight']; ?>
                                <div><a <?php if ($this->_vars['attrwhere'][$this->_vars['key']] == null): ?>class="curr"<?php endif; ?> href="<?php echo url(array('mod' => $this->_vars['c'],'action' => 'category','args2' => $this->_vars['attrwhere'],'args' => "att" . $this->_vars['volist']['weight'] . ":null"), $this);?>">不限</a></div>
                              ...
                              <?php if (count((array)$this->_vars['k'])): foreach ((array)$this->_vars['k'] as $this->_vars['value']): ?>  
                                ...
                                <div>
 <a <?php if ($this->_vars['attrwhere'][$this->_vars['key']] == $this->_vars['value']): ?>class="curr"<?php endif; ?> href="<?php echo url(array('mod' => $this->_vars['c'],'action' => $this->_vars['a'],'args' => "att" . $this->_vars['volist']['weight'] . ":" . $this->_vars['value'] . "",'args2' => $this->_vars['attrwhere']), $this);?>"><?php echo $this->_vars['value']; ?>
</a>
                </div>
                               <?php endforeach; endif; ?>
                            </dd>
 ...
 <?php endif; ?>
    ...
    <div class="filter clearfix">
        <div class="fore1 clearfix">
            <div class="order">
                                <a <?php if (! $this->_vars['orderby']['f']): ?>class="current"<?php endif; ?> href="<?php echo url(array('mod' => $this->_vars['c'],'action' => $this->_vars['a'],'args' => $this->_vars['by'],'args2' => $this->_vars['byattr']), $this);?>"><span>默认排序</span></a>
			<a class="<?php if ($this->_vars['orderby']['f'] == 'sells'):  echo $this->_vars['orderby']['s'];  endif; ?>" href="<?php echo url(array('mod' => $this->_vars['c'],'action' => $this->_vars['a'],'args' => $this->_vars['by'].":sells",'args2' => $this->_vars['byattr']), $this);?>"><span>销量</span><b></b></a>
                <!--<a class="<?php if ($this->_vars['orderby']['f'] == 'hits'):  echo $this->_vars['orderby']['s'];  endif; ?>" href="<?php echo url(array('mod' => $this->_vars['c'],'action' => $this->_vars['a'],'args' => $this->_vars['by'].":hits",'args2' => $this->_vars['byattr']), $this);?>"><span>人气</span><b></b></a>
                 <a class="<?php if ($this->_vars['orderby']['f'] == 'plpjf'):  echo $this->_vars['orderby']['s'];  endif; ?>" href="<?php echo url(array('mod' => $this->_vars['c'],'action' => $this->_vars['a'],'args' => $this->_vars['by'].":plpjf",'args2' => $this->_vars['byattr']), $this);?>"><span>信用</span><b></b></a>-->
           <a class="<?php if ($this->_vars['orderby']['f'] == 'addtime'):  echo $this->_vars['orderby']['s'];  endif; ?>" href="<?php echo url(array('mod' => $this->_vars['c'],'action' => $this->_vars['a'],'args' => $this->_vars['by'].":addtime",'args2' => $this->_vars['byattr']), $this);?>"><span>最新</span><b></b></a>
               <a class="<?php if ($this->_vars['orderby']['f'] == 'price'):  echo $this->_vars['orderby']['s'];  endif; ?>" href="<?php echo url(array('mod' => $this->_vars['c'],'action' => $this->_vars['a'],'args' => $this->_vars['by'].":price",'args2' => $this->_vars['byattr']), $this);?>"><span>价格</span><b></b></a>
            </div>
       	...
       	<div class="fore2 clearfix">
            ...
            <div class="list">
                ...
                <a href="<?php echo url(array('mod' => 'shop'), $this);?>"><span class="product"></span></a>
            </div>
		</div>
    </div>
    ...
    <div class="itemSearchList">
        <?php if ($this->_run_modifier($this->_vars['data'], 'sizeof', 'PHP', 1)): ?>
            ...
            <?php  $this->_vars['i']=$this->_vars['k']+1; ?>
                    ...
                    <div class="p-info">
                        <a class="p-img" href="<?php echo url(array('mod' => 'product','action' => 'detail','args' => "productid:" . $this->_vars['volist']['productid'] . ""), $this);?>">  <img height="200" width="200" alt="<?php echo $this->_vars['volist']['productid']; ?>
" src="<?php echo $this->_run_modifier($this->_vars['volist']['smallimg1'], 'imgsize', 'PHP', 1, '220,220'); ?>
"> </a>
                        <a class="p-name" href="<?php echo url(array('mod' => 'product','action' => 'detail','args' => "productid:" . $this->_vars['volist']['productid'] . ""), $this);?>"><?php echo $this->_run_modifier($this->_vars['volist']['productname'], 'tostr', 'PHP', 1); ?>
</a>
                        <p class="p-price"><strong><?php echo $this->_vars['config']['currency'];  echo $this->_vars['volist']['price']/100; ?>
</strong></p>
                      <div class="p-shop"><a href="<?php echo url(array('mod' => 'shop','action' => 'show','args' => "id:" . $this->_vars['volist']['muid'] . ""), $this);?>"><?php echo $this->_vars['volist']['merchantname']; ?>
</a></div>
                    </div>
                </li>
                        <?php endforeach; endif; ?>      
