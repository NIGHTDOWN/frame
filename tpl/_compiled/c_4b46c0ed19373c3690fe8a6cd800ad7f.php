<?php require_once('D:\work2\source\core\template\src\plugins\modifier.date_format.php'); $this->register_modifier("date_format", "tpl_modifier_date_format");  /* "ngtpl[start]:tpl/admin/article_index.html:[end]" 

	//NG框架模板引擎;仅适用本系统框架; 2018-11-23 13:37:36 */ ?>
...
<div class="oe_tools_bar clearfix">
    ...
    <a class="icon-remove-2" href="javascript:;" do="tools_submit({action:'<?php echo \ng169\hook\url(array('action' => "del"), $this);?>',id:'articleid'})" title="删除" onclick="boxyn($(this))"> 删除</a>
    <a href="<?php echo \ng169\hook\url(array('action' => "add_view"), $this);?>" class="icon-plus">添加</a>
...
" name="elite" tag="ajaxchoose" style="cursor:pointer;text-align:center;" >
        ...
        <a class="oe_ico_blue" href="<?php echo \ng169\hook\url(array('action' => "show",'args' => "articleid:" . $this->_vars['volist']['articleid'] . ""), $this);?>">编辑</a>
        <a class="oe_ico_red" a="<?php echo \ng169\hook\url(array('action' => "del",'args' => "articleid:" . $this->_vars['volist']['articleid'] . ""), $this);?>" onclick="boxyn($(this))">删除</a>
        </td>
      </tr>
