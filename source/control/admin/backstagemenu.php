...
class control extends adminbase
{
	...
	public function control_add()
	{
        ...
        $insert=array('string'=>array('catname'=>1,'alias','url','mod','action','indextpl','metatitle','metakeyword','metadesc','orders'),'int'=>array('parentid','urlflag','flag'));
        $recvar = G($insert)->get();
		...
		$status = M($this->db_name,'am')->save($recvar,$where);
