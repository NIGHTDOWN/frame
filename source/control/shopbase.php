...
class shopbase extends general
{
    private $pagesize = 15;
    public $tpl_path = 'tpl/shop';
    ...
    public function __construct()
    {
        ...
        $var_array = array(
            ...
            'city' => $city,
            'seo'=>$this->seoinit(),
           	'shoptpl'=>PATH_URL.$this->tpl_path.'/',
			'realshoptpl'=>ROOT.$this->tpl_path.'/',
    ...
    public function checkLogin()
    {
        ...
        if (!empty($userinfo)) {
            ...
            if ($userdbinfo['storeflag']) {
                out('店铺已锁定',geturl(null,null,'index','index'),0);
            }
            if ($userdbinfo == null) {
            } else {
                parent::$wrap_user = $userdbinfo;
                parent::$wrap_merchant = $userdbinfo;
                return 1;
            }
        } else {
            YOut::redirect(geturl(null,null,'login','index'), 0);
