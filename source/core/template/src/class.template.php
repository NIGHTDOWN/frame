...
class Template_Lite {
	...
	var $template_dir		= "";	// where the templates are to be found
	var $plugins_dir			= array("plugins");	// where the plugins are to be found
	var $compile_dir		= "/tpl/_compiled";	// the directory to store the compiled files in
	var $config_dir			= "templates";	// where the config files are
	var $cache_dir			= "/tpl/_caches";	// where cache files are stored
