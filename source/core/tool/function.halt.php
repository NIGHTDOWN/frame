...
<head>
<meta http-equiv="Content-Type" content="text/html; charset='; echo OESOFT_CHARSET; ;echo '" />
';
...
.alert .alert_body .alertcont{margin:15px 0 0 85px; background:url('; echo PATH_URL;;echo 'tpl/static/images/m_alert.png) left center no-repeat; padding:5px 50px; line-height:18px; color:#666; min-height:30px; _height:30px;}
...
.alert .alert_body .pi2{background:url('; echo PATH_URL; ;echo 'tpl/static/images/m_err.png) left center no-repeat;}
.alert .alert_body .pi1{background:url('; echo PATH_URL; ;echo 'tpl/static/images/m_acc.png) left center no-repeat; padding-left:55px;}
